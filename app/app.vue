...
async function handleSave(updatedData: {
  ...
  if (editMode.value === "principal" && editingPrincipal.value) {
    ...
    if (updatedData.status) body.status = updatedData.status;
...
<template>
  <div v-if="loading" class="loading">Loading org chart…</div>
  <div v-else-if="orgData">
    ...
    <div class="board-wrap">
      <div class="board-label">Organizational Structure</div>
      <div class="board">
